...
# Generating the nodes for a dfs or bfs: Weighted graph
nodes = {STARTINGNODE}
for _ in range(100): #<-- Need a much better maze generator
    w = random.randint(1,1000)
    h = random.randint(1,720)
    nodes.add((w,h))

# Getting End node and Starting node
ENDNODE = (w,h)
